...
/*
 * Documentation:
 * Badge — https://app.subframe.com/3f3ba0b30f1c/library?component=Badge_97bdb082-1124-4dd7-a335-b14b822d0157
 */
    ...
    return (
      <div
        className={SubframeCore.twClassNames(
          "group/97bdb082 flex h-6 items-center gap-1 rounded border border-solid border-brand-100 bg-brand-100 px-2",
          {

...
/*
 * Documentation:
 * Toast — https://app.subframe.com/3f3ba0b30f1c/library?component=Toast_2c7966c2-a95d-468a-83fe-bf196b95be7a
    ...
    return (
      <div
        className={SubframeCore.twClassNames(
          "group/2c7966c2 flex w-80 items-center gap-4 rounded bg-default-background px-4 py-3 shadow-overlay",
          className
        )}
        ref={ref as any}
        {...otherProps}

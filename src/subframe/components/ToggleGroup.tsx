...
/*
 * Documentation:
 * Toggle Group — https://app.subframe.com/3f3ba0b30f1c/library?component=Toggle+Group_2026f10a-e3cc-4c89-80da-a7259acae3b7
 */
    ...
    <SubframeCore.ToggleGroup.Item asChild={true} {...otherProps}>
      <div
        className={SubframeCore.twClassNames(
          "group/56dea6ed flex h-7 w-full cursor-pointer items-center justify-center gap-2 rounded px-2 py-1 active:bg-neutral-100 aria-[checked=true]:bg-default-background aria-[checked=true]:shadow-default hover:aria-[checked=true]:bg-default-background active:aria-[checked=true]:bg-default-background",
  ...
  function ToggleGroupRoot(
    ...
    return children ? (
      <SubframeCore.ToggleGroup.Root asChild={true} {...otherProps}>
        <div
          className={SubframeCore.twClassNames(
            "flex items-center gap-0.5 overflow-hidden rounded bg-neutral-100 px-0.5 py-0.5",
            className
          )}
          ref={ref as any}
        >

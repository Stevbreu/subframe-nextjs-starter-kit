...
/*
 * Documentation:
 * Sidebar rail with icons — https://app.subframe.com/3f3ba0b30f1c/library?component=Sidebar+rail+with+icons_0d7efe0e-8762-46f5-b399-9f6d329e13b9
        ...
        <SubframeCore.Tooltip.Trigger asChild={true}>
          <div
            className={SubframeCore.twClassNames(
              "group/ba3a61e5 flex cursor-pointer items-center gap-2 rounded px-2 py-2 hover:bg-neutral-50 active:bg-neutral-100",

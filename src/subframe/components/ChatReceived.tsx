...
/*
 * Documentation:
 * Chat Received — https://app.subframe.com/3f3ba0b30f1c/library?component=Chat+Received_be1cbd1f-58c2-47ae-8cac-39b31b82605f
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col items-start gap-1">
          ...
          <div className="flex max-w-[576px] flex-col items-start gap-2 rounded bg-neutral-100 px-3 py-2">
            {message ? (

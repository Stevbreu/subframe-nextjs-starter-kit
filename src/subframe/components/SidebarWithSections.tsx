...
/*
 * Documentation:
 * Sidebar with sections — https://app.subframe.com/3f3ba0b30f1c/library?component=Sidebar+with+sections_f4047c8b-cfb4-4761-b9cf-fbcae8a9b9b5
  ...
  return (
    <div
      className={SubframeCore.twClassNames(
        "group/2713e17b flex w-full cursor-pointer items-center gap-2 rounded px-3 py-2 hover:bg-neutral-50 active:bg-neutral-100",

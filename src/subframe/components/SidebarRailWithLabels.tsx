...
/*
 * Documentation:
 * Sidebar rail with labels — https://app.subframe.com/3f3ba0b30f1c/library?component=Sidebar+rail+with+labels_3296372a-ba83-4ca9-b291-10dc2aa86fdd
        ...
        <SubframeCore.Tooltip.Trigger asChild={true}>
          <div
            className={SubframeCore.twClassNames(
              "group/8815d632 flex min-h-[48px] w-full cursor-pointer flex-col items-center justify-center gap-2 rounded px-2 pt-3 pb-2 active:bg-neutral-50",
              {

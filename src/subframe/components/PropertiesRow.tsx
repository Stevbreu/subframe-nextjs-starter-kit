...
/*
 * Documentation:
 * Properties Row — https://app.subframe.com/3f3ba0b30f1c/library?component=Properties+Row_09e4ebd5-f53c-4b9a-8ef1-0a044ca4bdc4
 * Switch — https://app.subframe.com/3f3ba0b30f1c/library?component=Switch_7a464794-9ea9-4040-b1de-5bfb2ce599d9
 */
    ...
    return (
      <div
        className={SubframeCore.twClassNames(
          "flex w-full items-center border-b border-solid border-neutral-border bg-default-background px-4 py-3",
          className
        )}
        ref={ref as any}
        {...otherProps}

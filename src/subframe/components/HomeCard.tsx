...
/*
 * Documentation:
 * Home Card — https://app.subframe.com/3f3ba0b30f1c/library?component=Home+Card_318fa7af-69f9-4374-8e26-8ec8007254b5
    ...
    return (
      <div
        className={SubframeCore.twClassNames(
          "group/318fa7af flex h-full w-full cursor-pointer flex-col items-center gap-2 rounded border border-solid border-neutral-border bg-default-background px-6 py-6 shadow-default hover:bg-neutral-50",
          className
        )}
        ref={ref as any}
        {...otherProps}
